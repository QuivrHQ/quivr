    ...
    <div className="relative h-full">
      ...
      >
        <span
          ...
          style={{
            color: activeColorItem?.color || '#000000', // Fallback to black if no color
            backgroundColor: activeHighlightItem?.color || '#ffffff', // Fal
          }}
        >
          A
        </span>
          ...
          {HIGHLIGHT_COLORS.map(({ name, color }, index) => (
            <button
              ...
              onClick={() => {
                ...
                name !== "Default" && editor.commands.setHighlight({ color: color || '#000000' });
                setIsOpen(false);
              }}
              className="flex items-center justify-between rounded-sm px-2 py-1 text-sm text-stone-600 hover:bg-stone-100"
            >
