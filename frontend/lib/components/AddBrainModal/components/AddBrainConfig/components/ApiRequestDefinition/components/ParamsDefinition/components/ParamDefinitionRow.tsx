    ...
    <div className="flex flex-1 justify-between items-center py-4 border-b border-gray-300 relative gap-2">
      <div className={paramsNameStyle}>
        <input
          ...
          {...register(`${name}[${index}].name` as `params.${number}.name`)}
        />
      </div>
      <div className="flex-1">
        <input
          ...
          {...register(
            `${name}[${index}].description` as `params.${number}.description`
          )}
        />
      </div>
      <div className="flex-1">
        <select
          ...
          {...register(`${name}[${index}].type` as `params.${number}.type`)}
        >
      ...
      <div className="flex-1 justify-center flex">
        <input
          ...
          {...register(
            `${name}[${index}].required` as `params.${number}.required`
          )}
        />
      </div>
