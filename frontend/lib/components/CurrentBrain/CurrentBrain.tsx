	...
	if (remainingCredits === 0) {
		return (
			<div className={styles.no_credits_left}>
				<span>
					{"Bạn đã hết tín dụng! Nâng cấp kế hoạch của bạn ngay bây giờ để tiếp tục trò chuyện."}
				</span>
			</div>
		);
	}
		...
		<div className={styles.current_brain_wrapper}>
			<div className={styles.brain_infos}>
				<div className={styles.left}>
					<span className={styles.title}>{"Nói chuyện với"}</span>
