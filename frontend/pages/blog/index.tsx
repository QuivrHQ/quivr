  ...
  return (
    <div>
      <section className="w-full">
        <Head>
          <title>SpringerAI - Blog</title>
          <meta name="description" content="SpringerAI.app - Your Generative AI second brain builder's blog" />
        </Head>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <nav className="flex items-center justify-between">
              ...
              <div className="space-x-4">
                <Link className="text-zinc-900 hover:text-zinc-700" href="/">Try SpringerAI</Link>
              </div>
            </nav>
          </div>
        </header>
