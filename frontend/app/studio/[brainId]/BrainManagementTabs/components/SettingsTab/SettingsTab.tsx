...
export const SettingsTabContent = ({
	...
	const { t } = useTranslation(["translation", "knowledge", "brain"]);
			...
			>
				<div className={styles.main_container}>
					<div className={styles.main_infos_wrapper}>
						<span className={styles.section_title}>{brain.name}</span>
						<div className={styles.inputs_wrapper}>
							<div className={styles.brain_snippet_wrapper}>
								...
								<div
									className={`${styles.brain_snippet} ${hasEditRights ? styles.clickable : ""
										}`}
