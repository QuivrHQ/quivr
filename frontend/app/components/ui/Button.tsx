...
const ButtonVariants = cva(
  "px-8 py-3 text-sm text-center font-medium rounded-md focus:ring ring-primary/10 outline-none flex items-center justify-center gap-2 disabled:opacity-50 transition-opacity",
  {
    variants: {
      variant: {
        primary:
