...
def calculate_remaining_space(
    request, max_brain_size, max_brain_size_with_own_key, current_brain_size
):
    remaining_free_space = (
        float(max_brain_size_with_own_key) - current_brain_size
        if request.headers.get("Openai-Api-Key")
        else float(max_brain_size) - current_brain_size
    )
...
async def upload_file(
    ...
    remaining_free_space = calculate_remaining_space(
        request, max_brain_size, max_brain_size_with_own_key, current_brain_size
    )
