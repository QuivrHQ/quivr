import json
from typing import AsyncIterable, List, TypedDict
            ...
            if kind == "on_chat_model_stream":
                ...
                for item in output:
                    if "code_check" in item:
                        ...
                        prefix = item["code_check"]["generation"]["prefix"]
                        imports = item["code_check"]["generation"]["imports"]
                        code = item["code_check"]["generation"]["code"]


                        final_message = f"{prefix.strip()}\n\n **Imports**: \n```python\n{imports}\n```\n **Code**: \n```python \n{code}\n```"
