...
data_directory = "/data/"
folder_name = "Documents/Germany/Bundesland-Berlin"
...
class LlamaIndexBerlin(KnowledgeBrainQA):
    ...
    def _get_engine(self):
        ...
        DEFAULT_TEXT_QA_PROMPT_TMPL = (
            ...
            "{context_str}\n"
            "---------------------\n"
            "You are an experienced Berliner architect specializing in Berlin building codes, regulations, and norms."
