...
-- Rename the column
ALTER TABLE "public"."models" RENAME COLUMN "max_output" TO "max_output_tokens";

-- Set the default value for the renamed column
ALTER TABLE "public"."models" ALTER COLUMN "max_output_tokens" SET DEFAULT 2000;

-- Add a description to the renamed column
COMMENT ON COLUMN "public"."models"."max_output_tokens" IS 'Maximum number of tokens generated by the LLM.';
