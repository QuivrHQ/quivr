...
from backend.modules.onboarding.dto.inputs import OnboardingUpdatableProperties
from backend.modules.onboarding.entity.onboarding import OnboardingStates
from backend.modules.onboarding.repository.onboardings import Onboarding
from backend.modules.onboarding.repository.onboardings_interface import (
    OnboardingInterface,
)
