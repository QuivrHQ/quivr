...
async def filter_file(commons: CommonsDep, file: UploadFile, enable_summarization: bool, brain_id, openai_api_key):
    if await file_already_exists(commons['supabase'], file, brain_id):
        ...
        if file_extension in file_processors:
            await file_processors[file_extension](commons,file, enable_summarization, brain_id ,openai_api_key )
