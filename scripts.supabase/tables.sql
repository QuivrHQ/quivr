...
CREATE TABLE IF NOT EXISTS user_settings (
  user_id UUID PRIMARY KEY,
  models JSONB DEFAULT '["gpt-3.5-turbo-1106","gpt-4", "gpt-4-1106-preview", "ollama/llama2"]'::jsonb,
  daily_chat_credit INT DEFAULT 300,
  max_brains INT DEFAULT 30,
  max_brain_size BIGINT NOT NULL DEFAULT 100000000,
...
CREATE TABLE public.product_to_features (
    ...
    models JSONB NOT NULL DEFAULT '["gpt-3.5-turbo-1106"]'::JSONB,
