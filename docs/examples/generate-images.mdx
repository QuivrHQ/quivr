...
<Warning>
  Generating images costs around 2cts per image. Be carefully or you'll have a
  surprised bill.
</Warning>
...
You can now use this brain to generate images. You can also use it to generate images in your own app through the API.
