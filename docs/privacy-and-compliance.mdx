...
At Quivr, we place the utmost importance on the security and privacy of our users. This document serves as a comprehensive guide to our privacy and compliance practices, addressing key areas such as our open-source security model, telemetry usage, row-level policy enforcement, local data handling, compatibility with various Language Learning Models (LLMs), and our commitment to SOC2 compliance.
